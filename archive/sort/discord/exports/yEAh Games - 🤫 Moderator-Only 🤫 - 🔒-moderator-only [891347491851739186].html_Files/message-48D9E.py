...
async def on_message(message):
    ...
    if message.content.startswith('yeahhelp'):
        ...
        embedVar.add_field(name="Random Guy TCG",
                           value="―――――――――",
                           inline=False)
        embedVar.add_field(name="⠀", value="`yeahrgrules`", inline=False)
        embedVar.add_field(name="⠀", value="`yeahrgcynthia`", inline=False)
        embedVar.add_field(name="⠀",
                           value="`yeahrgtotallyrandomguy`",
                           inline=False)
        embedVar.add_field(name="⠀", value="`yeahrgscamguy`", inline=False)
        embedVar.add_field(name="⠀", value="`yeahrgscamartist`", inline=False)
        embedVar.add_field(name="⠀", value="`yeahrge`", inline=False)
        embedVar.add_field(name="⠀", value="`yeahrgwotrbotl`", inline=False)
        embedVar.add_field(name="⠀", value="`yeahrgderkvotr`", inline=False)
